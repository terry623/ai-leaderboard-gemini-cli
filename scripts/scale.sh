...
echo "Executing Gemini CLI to scrape scale leaderboard..."
gemini -m "gemini-2.5-flash" -y -p "
請從目標網址 https://scale.com/leaderboard 爬取「今日排行榜」資料，並將結果整理成 Markdown。
...
檔案名稱必須為 scale-leaderboard.md，不可更改或自行命名。
"