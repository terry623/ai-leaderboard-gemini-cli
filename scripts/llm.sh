...
echo "Executing Gemini CLI to scrape llm status leaderboard..."
gemini -m "gemini-2.5-flash" -y -p "
請從目標網址 https://llm-stats.com 爬取今日排行榜資料，並將結果整理成 markdown 格式。
...
4. 將結果儲存為檔案，檔名格式：llm-stats-leaderboard.md
